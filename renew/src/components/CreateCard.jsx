...
export default function CreateCard() {
    ...
    return (
        <div className="fixed top-0 left-0 flex flex-col justify-center items-center w-full h-full z-10 bg-color-black/90">
            <div className="text-color-white text-[30px] font-semibold">
                Create Your Card!
            </div>
            ...
            <div
                ...
                className="fixed top-[30px] right-[30px] w-[30px] h-[30px] rounded-[50%] bg-red-500 hover:bg-red-400 cursor-pointer"
            ></div>
        </div>
    )
}
